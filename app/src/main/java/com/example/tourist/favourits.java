...
public class favourits extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    FavAdapter.RecyclerClickListener listener = new FavAdapter.RecyclerClickListener() {
        @Override
        public void onClick(View view, int position) {
            Intent intent = new Intent(favourits.this, Country.class);
            intent.putExtra("CountryName", con.get(position));
    ...
    private void loadData() {
        ...
        favAdapter = new FavAdapter(con,getApplication(), favItemList,listener);
