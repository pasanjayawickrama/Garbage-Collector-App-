...
public class City extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    String cityKeyVar,countryKeyVar,pop,air,ctyImg,desc;
    TextView textView,view_city,view_temp,view_desc,population,airport,Description;
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent browserIntent = new Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("https://en.wikipedia.org/wiki/"+cityKeyVar+""));
